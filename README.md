<!-- Repo is named "rokayaprabin11-dev", so this renders on your profile. Just commit it. -->
<!-- Icons are FontAwesome 6 served as SVG via the Iconify API. -->

<div align="center">

# Hi, I'm Prabin 👋

### Full-stack developer from Nepal 🇳🇵 · Flutter & Django

Building geo-aware, bilingual apps for Nepali businesses & startups.

<a href="https://www.linkedin.com/in/prabinrokaya-dev/"><img src="https://img.shields.io/badge/LinkedIn-21262D?style=flat-square&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
...
## <img src="https://api.iconify.design/fa6-solid:user.svg?color=%2358a6ff&height=22" height="22" alt="" />&nbsp; Who am I?

- <img src="https://api.iconify.design/fa6-solid:graduation-cap.svg?color=%2358a6ff&height=17" height="17" alt="" />&nbsp; IT student at **Nepal Banepa Polytechnic Institute** (2024–2027), building real products alongside my studies.
- <img src="https://api.iconify.design/fa6-solid:laptop-code.svg?color=%2358a6ff&height=17" height="17" alt="" />&nbsp; **Full-stack web & mobile, end-to-end** — Flutter on mobile, Django on the backend.
- <img src="https://api.iconify.design/fa6-solid:landmark.svg?color=%2358a6ff&height=17" height="17" alt="" />&nbsp; I build **bilingual (EN/नेपाली), geo-aware** products for Nepal, and help local businesses grow with **SEO**.

## <img src="https://api.iconify.design/fa6-solid:person-digging.svg?color=%2358a6ff&height=22" height="22" alt="" />&nbsp; What I'm currently working on

- <img src="https://api.iconify.design/fa6-solid:landmark.svg?color=%2358a6ff&height=17" height="17" alt="" />&nbsp; **Sampada (सम्पदा)** — a Nepal heritage discovery app: Flutter (Clean Architecture) + Django REST with PostGIS geospatial & bilingual search, built end-to-end.
- <img src="https://api.iconify.design/fa6-solid:globe.svg?color=%2358a6ff&height=17" height="17" alt="" />&nbsp; **Freelance web + SEO** for local clients.
- <img src="https://api.iconify.design/fa6-solid:seedling.svg?color=%2358a6ff&height=17" height="17" alt="" />&nbsp; Going deeper on **Clean Architecture & system design**.

## <img src="https://api.iconify.design/fa6-solid:screwdriver-wrench.svg?color=%2358a6ff&height=22" height="22" alt="" />&nbsp; What tools do I use?
...
![Django REST](https://img.shields.io/badge/Django_REST-21262D?style=flat-square&logo=django&logoColor=white)

**Backend & Data** &nbsp;
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-21262D?style=flat-square&logo=postgresql&logoColor=white)
![PostGIS](https://img.shields.io/badge/PostGIS-21262D?style=flat-square&logo=postgresql&logoColor=white)
![Redis](https://img.shields.io/badge/Redis-21262D?style=flat-square&logo=redis&logoColor=white)
![Celery](https://img.shields.io/badge/Celery-21262D?style=flat-square&logo=celery&logoColor=white)
...
![VS Code](https://img.shields.io/badge/VS_Code-21262D?style=flat-square&logo=visualstudiocode&logoColor=white)
